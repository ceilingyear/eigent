...
# Backward-compatible chat step route for older agents that still sync to
# /api/chat/steps instead of /api/v1/chat/steps.
from app.domains.chat.api.step_controller import router as chat_step_router
api.include_router(chat_step_router, prefix=prefix)
