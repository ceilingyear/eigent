...
import eigentLogo from '@/assets/logo/eigent_icon.jpg';
    ...
    <div className="relative flex w-80 flex-1 flex-col items-center justify-center pt-8">
      ...
      >
        <span className="flex-1">
          {isLoading ? t('layout.logging-in') : '启动 ATAI'}
        </span>
      </Button>
    </div>
  );
