  ...
  return (
    ...
    >
      <div className="bg-bg-surface-primary/95 border-border-default pointer-events-auto flex items-center gap-2 rounded-full border p-1 shadow-[0px_4px_16px_rgba(0,0,0,0.12)] backdrop-blur-md">
        {/* Always show stop button when running. */}
        <Button
          variant="outline"
          size="sm"
          onClick={onSkip}
        ...
        >
          <span className="text-sm font-semibold">停止任务</span>
        </Button>
				...
				{status === "running" ? (
					...
					<>
						...
						>
							...
							<span className="text-sm font-semibold">继续</span>
						</Button>
						<Button
							variant="outline"
							size="sm"
							...
							className="gap-1.5 rounded-full"
						>
							<span className="text-sm font-semibold">下一个任务</span>
						</Button>
					</>
				)}
				*/}
